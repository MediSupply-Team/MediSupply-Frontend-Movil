            ...
            <View className="flex-1 px-6 py-8">
              ...
              <View className="flex-1 justify-center">
                ...
                <View className="items-center mb-12">
                  <View className="bg-[#1193d4] w-20 h-20 rounded-full items-center justify-center mb-6">
                  ...
                  <Text className="text-gray-500 mt-2">
                    Acceso para clientes institucionales
                  </Text>
                </View>
                ...
                <View className="mt-8">
                  <TouchableOpacity
                    className="w-full h-14 rounded-xl bg-[#1193d4] items-center justify-center shadow-md"
                    onPress={handleLogin}
                    disabled={isLoading}
                    activeOpacity={0.8}
                  >
                ...
                <View className="items-center mt-6">
                  <TouchableOpacity disabled={isLoading}>
                    <Text className="text-[#1193d4] text-sm font-medium">
          ...
          <View className="px-6 py-8 border-t border-gray-100">
            <View className="items-center">
              <Text className="text-gray-500 text-sm">
                ¿No tiene una cuenta?{' '}
                <Text
                  className="text-[#1193d4] font-medium"
                  onPress={() => !isLoading && router.push('/register' as any)}
                >
                  Regístrese aquí
                </Text>
              </Text>
